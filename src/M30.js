...
function M30(){
    return(
     <h3><h2>M30:</h2>Quad Camera Setup - 64MP (F1.8) Main Camera +8MP (F2.2) Ultra Wide Camera +5MP(F2.2) Depth Camera +5MP(F2.4) Macro Camera and 32MP (F2.0) front facing Camera
     ...
     For any product related queries contact brand toll free number - 180057267864</h3>
    )
